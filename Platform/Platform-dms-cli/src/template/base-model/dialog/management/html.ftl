<div v-if="$hasPerm(queryPerm)">
    ...
    <{{config.name}}-page-{{names.middleLine}}-add v-if="showBtnAdd && $hasPerm(addPerm)" :show="showAddDialog" :callback="ok" @close="close"></{{config.name}}-page-{{names.middleLine}}-add>
    <{{config.name}}-page-{{names.middleLine}}-edit v-if="showBtnEdit && $hasPerm(editPerm)" :model="editModel" :show="showEditDialog" :callback="ok" @close="close"></{{config.name}}-page-{{names.middleLine}}-edit>
</div>
